...
MarijnScene::MarijnScene() :AbstractGame(), _hud(0)
{
}

void MarijnScene::initialize() {
	//setup the core part
...
void MarijnScene::_initializeScene()
{
